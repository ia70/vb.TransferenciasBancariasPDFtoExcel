...
Public Class D_CamposNombre
#Region "Variables"
    Private Tabla As String = "campos_nombre"
...
#Region "Funciones"
    ...
    Public Function Insertar(ByVal Obj As I_CamposNombre) As Boolean
        Dim DB As New DataBase
    ...
    ''' <param name="Obj">Objeto Identidad</param>
    ''' <returns>True - Si exitoso</returns>
    Public Function Editar(ByVal Obj As I_CamposNombre) As Boolean
        Dim DB As New DataBase
