...
Public Class D_CamposFin
#Region "Variables"
    Private Tabla As String = "campos_fin"
...
#Region "Funciones"
    ...
    Public Function Insertar(ByVal Obj As I_CamposFin) As Boolean
        Dim DB As New DataBase
    ...
    ''' <param name="Obj">Objeto Identidad</param>
    ''' <returns>True - Si exitoso</returns>
    Public Function Editar(ByVal Obj As I_CamposFin) As Boolean
        Dim DB As New DataBase
